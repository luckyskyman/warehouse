...
export class MemStorage implements IStorage {
  ...
  private initializeSampleInventory() {
    const sampleItems: InventoryItem[] = [
      ...
      // BOM 체크 테스트를 위한 실제 부품들만 일부 포함
      {
        id: this.currentItemId++,
        code: "60011059",
        name: "MK3 GRID, T/S SPREADER PLATE, 3 HOLE",
        category: "산업자재",
        manufacturer: "Ocado",
        stock: 120,
        minStock: 20,
      ...
      },
      {
        id: this.currentItemId++,
        code: "60011064",
        name: "MK3 GRID, T/S SPREADER PLATE, 4 HOLE",
        category: "산업자재",
        manufacturer: "Ocado",
        stock: 90,
        minStock: 15,
      ...
      },
      {
        id: this.currentItemId++,
        code: "30011554",
        name: "SET - M12x40 BOLT/NUT/WASHER",
        category: "산업자재",
        manufacturer: "Ocado",
        stock: 500,
        minStock: 50,
